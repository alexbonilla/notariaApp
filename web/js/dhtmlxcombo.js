...
function dhtmlXComboFromSelect(a, b) {
    ...
    for (var e = a.getAttribute("opt_type"), d = new dhtmlXCombo(c, a.name, b, e, a.tabIndex), f = [], h = -1, g = 0; g < a.options.length; g++) {
        a.options[g].selected &&
                (h = g);
        var j = a.options[g].innerHTML, i = a.options[g].getAttribute("value");
    ...
    if (h >= 0)
        d._skipFocus = !0, d.selectOption(h, null, !0);
...
function dhtmlXCombo(a, b, c, e, d) {
    ...
    if (!window.dhx_glbSelectAr)
        window.dhx_glbSelectAr = [], window.dhx_openedSelect = null, window.dhx_SelectId = 1, dhtmlxEvent(document.body, "click", this.closeAll), dhtmlxEvent(document.body,
                "keydown", function(a) {
                    try {
    ...
    if (a.tagName == "SELECT")
        return dhtmlXComboFromSelect(a);
    else
        this._createSelf(a, b, c, d);
...
dhtmlXCombo.prototype.enableFilteringMode = function(a, b, c, e) {
    ...
    if (b)
        this._xml = b, this._autoxml = convertStringToBoolean(e);
...
dhtmlXCombo.prototype.addOption = function(a) {
    ...
    for (var b = 0; b < args.length; b++) {
        var c = args[b];
        if (c.length)
            c.value = c[0] || "", c.text = c[1] || "", c.css = c[2] || "";
        this._addOption(c)
    }
    this.render(!0)
};
...
dhtmlXCombo.prototype.setComboValue = function(a) {
    ...
    for (var b = 0; b < this.optionsArr.length; b++)
        if (this.optionsArr[b].data()[0] == a)
            return this._skipFocus = !0, this.selectOption(b, null, !0);
...
dhtmlXCombo.prototype._createSelf = function(a, b, c, e) {
    ...
    if (_isIE)
        this.DOMlistF = document.createElement("IFRAME"), this.DOMlistF.style.border = "0px", this.DOMlistF.className = "dhx_combo_list", this.DOMlistF.style.width = c - (_isIE ? 0 : 0) + "px", this.DOMlistF.style.display = "none", this.DOMlistF.src =
...
dhtmlXCombo.prototype.getPosition = function(a, b) {
    if (_isIE && _isIE < 8) {
        if (!b)
            b = document.body;
        for (var c = a, e = 0, d = 0; c && c != b; )
            e += c.offsetLeft - c.scrollLeft + c.clientLeft, d += c.offsetTop - c.scrollTop + c.clientTop, c = c.offsetParent;
...
dhtmlXCombo.prototype.selectNext = function(a) {
    for (var b = this.getSelectedIndex() + a; this.optionsArr[b]; ) {
        if (!this.optionsArr[b].isHidden())
            return this.selectOption(b, !1, !1);
        b += a
    }
};
...
dhtmlXCombo.prototype._onKey = function(a) {
    ...
    if (c == 27)
        return!0;
    if (b.DOMlist.style.display != "block" && c != "13" && c != "9" && (!b._filter || b._filterAny))
        b.DOMelem.onclick(a || event);
    if (c != "13" && c != "9") {
        ...
        b._confirmSelection(), b.closeAll(), (a || event).cancelBubble = !1
};
dhtmlXCombo.prototype._onKeyB = function(a) {
    if (a == "40")
        var b = this.selectNext(1);
    else if (a == "38")
        this.selectNext(-1);
    else {
        ...
        for (var c = 0; c < this.optionsArr.length; c++)
            if (this.optionsArr[c].data()[1] == this.DOMelem_input.value)
                return this.selectOption(c, !1, !1), !1;
        this.unSelectOption()
    }
    return!0
};
...
dhtmlXCombo.prototype.redrawOptions = function() {
    if (!this._skiprender) {
        ...
        for (a = 0; a < this.optionsArr.length; a++)
...
dhtmlXCombo.prototype.loadXML = function(a, b) {
    ...
    if (this._xmlCache && this._xmlCache[a])
        this._fillFromXML(this, null, null, null, this._xmlCache[a]), b && b();
    else {
...
dhtmlXCombo.prototype._fillFromXML = function(a, b, c, e, d) {
    ...
    if (f.tagName != "complete")
        ...
        if (!h[0] || !h[0].getAttribute("add")) {
            ...
            a._lastLength += g.length || Infinity, j = !0;
        for (var i = 0; i <
                g.length; i++) {
            var k = {};
        ...
        if (n.length)
            a._skipFocus = !0, a.selectOption(a.getIndexByValue(n[0].getAttribute("value")), !1, !0);
        a.callEvent("onXLE", [])
    }
};
...
dhtmlXCombo.prototype._fetchOptions = function(a, b) {
    if (b == "")
        return this.closeAll(), this.clearAll();
    ...
    if (window.dhx_glbSelectAr)
        for (var a = 0; a < dhx_glbSelectAr.length; a++) {
            if (dhx_glbSelectAr[a].DOMlist.style.display == "block")
                dhx_glbSelectAr[a].DOMlist.style.display = "none", _isIE && dhx_glbSelectAr[a]._IEFix(!1);
    ...
    this.eventCatcher = function(a) {
        var b = [], c = a, e = function(a, b) {
            ...
            for (var d = 0; d < b.length; d++)
                if (b[d] != null)
                    var e = b[d].apply(c, arguments), a = a && e;
            return a
        };
